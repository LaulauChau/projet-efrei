...
<footer >
      <div class="content-footer">
        ...
        <div class="bloc footer-contact center" >
          ...
          <ul class="schedule-list">
            <li>
              <a href="https://www.nike.com/fr/">
                <img class="logonike" src="../image/LogoNike.png">
              </a>
            </li>
            <li>
              <a href="https://www.nike.com/fr/">
                <img class="logojordan" src="../image/LogoJordan.png">
              </a>
            </li>
            <li>
              <a href="https://www.adidas.fr/">
                <img class="logoadidas" src="../image/LogoAdidas.png">
              </a>
            </li>
          </ul>
        </div>
      ...
      <div style="text-align:center">
        <span style="font-weight:bold;">2023 © FERREIRA Nelson  - ENGAMBE Mathias - TA Kevin  - CHAU Laurent</span>
    </div>
    </footer>